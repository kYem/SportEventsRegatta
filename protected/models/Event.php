...
class Event extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, name, boat, boat_search, star_date, end_date, min_participant, max_participant, age_id, organisation_id, seats', 'safe', 'on'=>'search'),
		);
	}
